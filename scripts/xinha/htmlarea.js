  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --  $LastChangedDate: 2005-06-27 08:03:17 -0700 (Mon, 27 Jun 2005) $
...
HTMLArea.version =
{
  ...
  'Date'      : '$LastChangedDate: 2005-06-27 08:03:17 -0700 (Mon, 27 Jun 2005) $'.replace(/^[^:]*: ([0-9-]*) ([0-9:]*) ([+0-9]*) \((.*)\) \$/, '$4 $2 $3'),
  'Revision'  : '$LastChangedRevision: 245 $'.replace(/^[^:]*: (.*) \$$/, '$1'),
