...
replace into badges ( id, name, include, include_function, include_function_args, publish ) values (  29, "Related Forms", "AMP/Badge/RelatedForms.php", "amp_badge_related_form", "", 1 );
