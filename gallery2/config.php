 ...
 */
$gallery->setConfig('setup.password', 'x');
 ...
 */
$gallery->setConfig('data.gallery.base', AMP_LOCAL_PATH.'/g2data');
...
$storeConfig['hostname'] = AMP_DB_HOST;
$storeConfig['database'] = AMP_DB_NAME;
$storeConfig['username'] = AMP_DB_USER;
$storeConfig['password'] = AMP_DB_PASS;
