...
// *** Insert Record: set Variables
  if ( ((isset($_POST['MM_update'])) && (isset($_POST['MM_recordId'])) ) or (isset($_POST['MM_insert'])) or ((isset($_POST['MM_delete'])) && (isset($_POST['MM_recordId']))) ) {
      //Delete cached versions of output file
//  $dbcon->Execute("DELETE FROM cachedata WHERE CACHEKEY LIKE '%calendar%';")or DIE($dbcon->ErrorMsg());

   // $MM_editConnection = MM__STRING;
    $MM_editTable  = "calendar";
    $MM_editColumn = "id";
    $MM_recordId = "" . $_POST['MM_recordId'] . "";
    $MM_editRedirectUrl = "calendar_gxlist.php";
...
if (isset($HTTP_GET_VARS["id"]))
  {$calendaritems__MMColParam = $HTTP_GET_VARS["id"];}
    $calendaritems=$dbcon->Execute("SELECT * FROM calendar where id = ".$calendaritems__MMColParam."") or DIE($dbcon->ErrorMsg());
