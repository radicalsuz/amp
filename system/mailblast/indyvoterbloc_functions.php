...
function handle_request() {
	...
	if ($id != '' || $sqlp !='') {
	print_form($id,$subject,$body,$emailfrom,$emailname,$sqlp, TRUE, $modin);
			return true;
	}
	...
	elseif ($action == 'save') {
		if ( $bounce == '' || $subject == '' || $body == ''|| $emailfrom == '' || $emailname == '' ) {
			...
			print_form($list,$subject,$body,$emailfrom,$emailname,$passedsql, TRUE, $modin);
			return true;
		}
...
function print_form($id,$subject,$body,$emailfrom,$emailname,$passedsqlx, $restrict=FALSE, $modin='') {
global $dbcon;
/*
...
?>	
	...
	<input type="hidden" name="modin" value="<?=$modin?>">
	<tr><td>From Name:</td></tr>

	<tr><td><?php
			print	'<input type="text" name="emailname" size="40" value="'.htmlentities($emailname).'">';
	...
	<tr><td>Subject:</td></tr>
	<tr><td>
<input type="text" name="subject" size="40" value="<?=htmlentities($subject)?>">
	</td></tr>
	...
	<?php
		if ($restrict) {
			print '<input type="hidden" name="emailfrom" size="40" value="'.$emailfrom.'">'.$emailfrom;
		} else {	
			print '<input type="text" name="emailfrom" size="40" value="'.htmlentities($MM_email_list).'">';
		} ?>
			</td></tr>
	...
	<?php
		if ($restrict) {
			print '<input type="hidden" name="bounce" size="40" value="'.$emailfrom.'">'.$emailfrom;
		} else {
			print '<input type="text" name="bounce" size="40" value="'.htmlentities($MM_email_list).'">';
		}
	?>
	</td></tr>
