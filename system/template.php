...
$html .= addfield('extra_headers','Extra Headers','textarea',$R->Fields("extra_headers"));
$html .= $buildform->add_content($buildform->add_btn() .'&nbsp;'. $buildform->del_btn().$rec_id->fetch());
