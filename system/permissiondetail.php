...
$fieldsarray=array('Name'=>'name','ID'=>'id','Publish'=>'publish');
...
$html .= addfield('name','Name','text',$r['name']);
$html .= addfield('description','Description','textarea',$r['description']);
$html .= addfield('id','ID','text',$r['id']);
