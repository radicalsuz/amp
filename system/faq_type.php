...
$table = "faqtype";
$listtitle ="FAQ Types";
$listsql ="select id ,type, uselink   from $table  ";
$orderby =" order by type asc  ";
$fieldsarray=array( 'FAQ Type'=>'type','Publish'=>'uselink'
					);
$filename="faq_type.php";
...
if ((($_POST['MM_update']) && ($_POST['MM_recordId'])) or ($_POST['MM_insert']) or (($_POST['MM_delete']) && ($_POST['MM_recordId']))) {
	...
	$MM_editColumn = "id";
	$MM_fieldsStr = "type|value|uselink|value";
...
$html .= addfield('type','FAQ Type','text',$R->Fields("type"));
$html .= addfield('uselink','Publish','checkbox',$R->Fields("uselink"),1);
