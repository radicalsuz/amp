...
// SET VARIABLES ///////////////////////////////////////////////////////////////////////////////////
  ...
  $pic_path = $_SERVER['DOCUMENT_ROOT']."/path/to/your/imagedirectory/";

  $org = $_GET['org'];
  $res = str_replace($pic_path, $pic_path."crop_", $org);
  $crw = $_GET['crw'];
  $crh = $_GET['crh'];
...
// SCRIPT CONTROL VIA VARIABLE $crA ////////////////////////////////////////////////////////////////
  ...
  switch($crA){
     ...
     case def:
	  ...
	  #header("Content-Type: image/jpeg");
	  #imagejpeg($im,"",$jpegqual);
	 ?><a href="#" onClick="top.close();"><img alt="<?=$txt['closewindow']?>" src="<?=$redirect?>?crA=img&org=<?=$org?>" border=0></a>
<?php	  
imagedestroy($im);
	  break;
     default:
