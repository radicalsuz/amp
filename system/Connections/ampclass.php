...
print "launching_nowys";
	}	
	return $output;
}

function get_htmlarea_javascript($textarea_ids) {
    ...
    </script>' . javascript_initEditor($textarea_ids);
}

function javascript_initEditor($textarea_ids) {
...
function write_htmlarea($textarea_id, $textarea_name, $value, $html=NULL) {
	$output = get_htmlarea_javascript($textarea_id)
			. get_htmlarea_textarea($textarea_id, $textarea_name, $value, $html);
	return $output;
}
