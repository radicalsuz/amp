...
$sys_nav[1][3]['link'] ='calendar_type.php?acton=list';
...
$sys_nav[8][1]['link'] ='photo_list.php';
$sys_nav[8][1]['name'] ='View/Edit';
$sys_nav[8][2]['link'] ='photo_typelist.php';
...
$sys_nav[19][0]['link'] ='articlelist.php';
$sys_nav[19][0]['name'] ='View/Edit Content';
$sys_nav[19][1]['link'] ='article_edit.php';
$sys_nav[19][1]['name'] ='Add Content';
$sys_nav[19][2]['link'] ='article_list.php?&class=2';
$sys_nav[19][2]['name'] ='View/Edit Homepage Content';
$sys_nav[19][3]['link'] ='article_fpedit.php';
$sys_nav[19][3]['name'] ='Add Homepage Content';

$sys_nav[19][4]['title'] ='Docs and Images';

$sys_nav[19][5]['link'] ='docdir.php';
$sys_nav[19][5]['name'] ='View Document';
...
$sys_nav[19][10]['link'] ='edittypes.php';
$sys_nav[19][10]['name'] ='View/Edit Sections';
$sys_nav[19][11]['link'] ='type_edit.php';
$sys_nav[19][11]['name'] ='Add Section';
...
# navigation
$sys_nav[30][0]['link'] ='module_nav_edit.php?id=1';
$sys_nav[30][0]['name'] ='Defualt Navigation Layout';
$sys_nav[30][1]['link'] ='module_nav_edit.php?id=2';
