...
<br>
        <table width="90%" border="0">
          ...
          <tr> 
            <td colspan="2" class="intitle"><?php echo helpme("main html template"); ?>main 
              html template</td>
          </tr>
          <tr> 
            <td class="name"><p>Template Field #1</p>
              <p> header<br>
                start left nav</p></td>
            <td> <textarea name="header2c" cols="65" rows="50" wrap="VIRTUAL" id="header2c"><?php echo $Recordset1->Fields("header2")?></textarea></td>
          </tr>
          <tr> 
            <td colspan="2" class="intitle"><?php echo helpme("side navigation"); ?>left 
              side navigation (admin edit only)</td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2" class="intitle"><?php echo helpme("side navigation"); ?>right 
              side side navigation (admin edit only)</td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2" class="intitle"><?php echo helpme("other template features"); ?>other 
