...
//    $MM_editConnection = $MM__STRING;
    ...
    $MM_columnsStr = "navid|none,none,NULL|position|',none,''|typeid|none,none,NULL|id|none,none,NULL";
...
$mod_id = $HTTP_GET_VARS["id"];
 $navfiles=$dbcon->Execute("SELECT * FROM nav WHERE typeid=$id order by position asc") or DIE($dbcon->ErrorMsg());
    $navfiles_numRows=0;
...
?>
    ...
    <input type="hidden" name="moduleid" value="<?php echo $navfiles->Fields("typeid"); ?>">
...
<a href="type_nav_add.php?id=<?php echo $HTTP_GET_VARS["id"]; ?>"> Insert Another Navigation File</a><br>
