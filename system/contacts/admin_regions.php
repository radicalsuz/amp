...
if (isset($HTTP_GET_VARS["id"]))
 ...
 $Recordset1=$dbcon->Execute("SELECT id, title, description FROM region WHERE id = " . ($Recordset1__MMColParam) . "") or DIE($dbcon->ErrorMsg());
...
<h2>Region <?php echo $Recordset1->Fields("id") ?></h2>
