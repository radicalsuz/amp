...
$formtitle = "Task Class";
$named = "class";
$tablein = "vol_taskclass";
$filename = "vol_taskclassedit.php";
...
?>
<?php
   $all=$dbcon->Execute("SELECT *  FROM $tablein ") or DIE($dbcon->ErrorMsg());
...
?>
  <tr bgcolor="#CCCCCC"> 
    <td> 
      <?php echo $all->Fields("$named")?>
    </td>
    <td> 
      <?php echo $all->Fields("id")?>
    </td>
