...
if (isset($id)) {
	$hiarticle=$dbcon->CacheExecute("Select title from articles where id = $id")
		or DIE($dbcon->ErrorMsg());
}
...
if (isset($isanarticle)) {
	...
	if (!$_GET["list"] && $MM_id && !$mod_name) { 
		...
		$bchtml.= "<span class=breadcrumb></span>&nbsp;&nbsp;<strong>&#187;</strong>&nbsp;&nbsp;"
				. $tttext . "</span>";
	}
}

if (!$_GET["list"] && $mod_name) {
	$bchtml.= "&nbsp;<strong>&nbsp;&#187;</strong>&nbsp;&nbsp;" . $mod_name;
}
	
if ($_GET["list"] == "class") {
	$bchtml.= "<b>&nbsp;&#187;&nbsp;</b><a href=\"" . $Web_url
			. "article.php?list=class&class=" . $MM_class
			. "\" class=breadcrumb>" . $hiclass->Fields("class")."</a>";
}  
